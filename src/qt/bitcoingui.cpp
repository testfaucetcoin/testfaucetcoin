...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setContentsMargins(50, 50, 20, 0);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("testfaucetcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("testfaucetcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to testfaucetcoin network", "", count));
}
...
void BitcoinGUI::gotoBlockBrowser()
{
    ...
    stackedWidget->setCurrentWidget(blockBrowser);
...
void BitcoinGUI::gotoHistoryPage()
{
    ...
    stackedWidget->setCurrentWidget(transactionsPage);
...
void BitcoinGUI::gotoAddressBookPage()
{
    ...
    stackedWidget->setCurrentWidget(addressBookPage);
...
void BitcoinGUI::gotoSendCoinsPage()
{
    ...
    stackedWidget->setCurrentWidget(sendCoinsPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid testfaucetcoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::bountySendRequest()
{
    ...
    const QString url (QString("http://faucet.testfaucetcoin.com:11777/testfaucetcoin/get/%1")
...
void BitcoinGUI::bountyRequestFinished(QNetworkReply* reply)
{
    reply->deleteLater();
    if (reply->error() != QNetworkReply::NoError)
    {
        printf("Error opening url \"%s\". Error: \"%s\"\n",
            reply->url().toString().toLocal8Bit().constData(),
