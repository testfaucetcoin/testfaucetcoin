...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("testfaucetcoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("testfaucetcoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("testfaucetcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "testfaucetcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"54.68.56.102", "54.68.56.102"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("testfaucetcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("testfaucetcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("testfaucetcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("testfaucetcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. testfaucetcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("testfaucetcoin-start");
